...
export default function HeaderComponent({mapText,isMap,isConfirmModal,setIntroFn}) {
                            ...
                            <div className={`row2 ${state.isFix?' on':''}`}>
                                <div className="container">
                                    ...
                                    <div className="right">
                                        ...
                                        <span><Link to="/cart"><img src="./images/sign_up/cart.svg" alt="" /><em>1</em></Link></span>
                                    </div>
                                </div>
                            </div>

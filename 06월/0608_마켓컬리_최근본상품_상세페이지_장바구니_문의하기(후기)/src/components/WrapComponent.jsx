        ...
        <div id='wrap'>
            {
                ...
                <BrowserRouter basename={process.env.PUBLIC_URL}>
                    <Routes>
                        <Route path="/" element={ <HeaderComponent setIntroFn={setIntroFn} mapText={state.mapText} isMap={state.isMap} isConfirmModal={state.isConfirmModal} cartCount={cartCount}/>}>

...
<head>
    ...
    <style>
        *{margin: 0;padding: 0;box-sizing: border-box;vertical-align: middle;}
        ...
        #wrap h2{text-align: center; font-weight: 600; color: #666; }
                        ...
                        <ul>
                            ...
                            <li>
                                <div>
                                    ...
                                    <div class='center-box'>
                                        <input type="text" name='userpw2' id='userPw2' placeholder='비밀번호를 확인해주세요' />
                                    </div>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div>
                                    ...
                                    <div class="center-box gender">
                                        <label htmlFor="userMale"> <input type="radio"   name='usergender' id='userMale' value="남자"/>남자</label>
                                        <label htmlFor="userFemale"> <input type="radio" name='usergender' id='userFemale' value="여자"/>여자</label>
                                        <label htmlFor="userNone"> <input type="radio" name='usergender' id='userNone' value="선택안함" />선택안함</label>
                                    </div>
                                </div>
                            </li>
                            <li>
            ...
            $('.submit-btn').on({
                click(e){
                    ...
                    const formData={
                        ...
                        addr:$('#addr').val(),
                        addr2:$('#addr2').val(),
                        user_gender1:$('#userMale').val(),
                        user_gender2:$('#userFemale').val(),
                        user_gender3:$('#userNone').val(),
                        user_birth_year:$('#userBirthYear').val(),
                        user_birth_month:$('#userBirthMonth').val(),
                        user_birth_date:$('#userBirthDate').val(),

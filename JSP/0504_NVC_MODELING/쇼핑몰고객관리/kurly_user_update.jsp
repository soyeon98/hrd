            ...
            <div class="container">
                ...
                <div class="content">
                    <form action="./kurly_user_update_action.jsp" name="update" id="update" method="post">
                        <ul>
                            <li><input type="text" autofocus required maxlength="16" name="user_id" id="userId" placeholder="등록된 아이디를 입력하세요"></li>
                            <li><input type="text" autofocus required maxlength="16" name="user_pw" id="userPw" placeholder="수정할 비밀번호를 입력하세요"></li>

                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <input 
                                                                        ...
                                                                        id='userBirthYear' 
                                                                        placeholder='YYYY'
                                                                        value="<%=userDTO.getUser_birth_year()%>"
                                                                    /></li>
                                                                <li><i>/</i></li>
                                                                <li>
                                                                    <input 
                                                                        ...
                                                                        id='userBirthMonth' 
                                                                        placeholder='MM' 
                                                                        value="<%=userDTO.getUser_birth_month()%>"
                                                                    /></li>
                                                                <li><i>/</i></li>
                                                                <li>
                                                                    <input 
                                                                        ...
                                                                        id='userBirthDate' 
                                                                        placeholder='DD' 
                                                                        value="<%=userDTO.getUser_birth_date()%>"
                                                                    /></li>
                                                            </ul>
                                                        </div>
                                                    </div>                                       
                                            ...
                                            <li>
                                                <div>
                                                    ...
                                                    <div class="center-box chooga">
                                                        <label>
                                                            <input type='radio' name='user_chooga' id='userChooga1' value='친구초대 추천인 아이디' <% if(userDTO.getUser_chooga().equals("친구초대 추천인 아이디")){%>checked="checked"<%}%>>친구초대 추천인 아이디
                                                        </label>
                                                        <label>
                                                            <input type='radio' name='user_chooga' id='userChooga2' value='참여 이벤트명' <% if(userDTO.getUser_chooga().equals("참여 이벤트명")){%>checked="checked"<%}%>>참여 이벤트명
                                                        </label>                                                
                                                    </div> 
                                                </div>
                                            </li>
                                                    ...
                                                    <ul>
                                                            <li>
                                                                <label>
                                                                    <input 
                                                                        ...
                                                                        id='userServiceAll' 
                                                                        value='전체 동의합니다.' 
                                                                        <% if(userDTO.getUser_service_all()!=null){if(userDTO.getUser_service_all().equals("전체 동의합니다.")){%>checked="checked"<%}}%>
                                                                    />전체 동의합니다.</label>                                                
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input                                                                 
                                                                        ...
                                                                        id='userService1' 
                                                                        value='이용약관 동의(필수)' 
                                                                        <% if(userDTO.getUser_service_1()!=null){if(userDTO.getUser_service_1().equals("이용약관 동의(필수)")){%>checked="checked"<%}}%>
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input 
                                                                        ...
                                                                        <% if(userDTO.getUser_service_2()!=null){if(userDTO.getUser_service_2().equals("개인정보 수집∙이용 동의(필수)")){%>checked="checked"<%}}%>
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input 
                                                                        ...
                                                                        <% if(userDTO.getUser_service_3()!=null){if(userDTO.getUser_service_3().equals("개인정보 수집∙이용 동의(선택)")){%>checked="checked"<%}}%>
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input 
                                                                        ...
                                                                        <% if(userDTO.getUser_service_4()!=null){if(userDTO.getUser_service_4().equals("무료배송, 할인쿠폰 등 혜택/정보 수신 동의(선택)")){%>checked="checked"<%}}%>
                                                            ...
                                                            <li class='service56'>
                                                                <label>
                                                                    <input 
                                                                        ...
                                                                        id='userService5' 
                                                                        value='SNS'
                                                                        <% if(userDTO.getUser_service_5()!=null){if(userDTO.getUser_service_5().equals("SNS")){%>checked="checked"<%}}%>
                                                                    />SNS</label>                                                    
                                                                <label>
                                                                    <input 
                                                                        type='checkbox' 
                                                                        ...
                                                                        id='userService6' 
                                                                        value='이메일'
                                                                        <% if(userDTO.getUser_service_6()!=null){if(userDTO.getUser_service_6().equals("이메일")){%>checked="checked"<%}}%>
                                                                    />이메일</label>
                                                            ...
                                                            <li>
                                                                <label><input 
                                                                            ...
                                                                            <% if(userDTO.getUser_service_7()!=null){if(userDTO.getUser_service_7().equals("본인은 만 14세 이상입니다.(필수)")){%>checked="checked"<%}}%>

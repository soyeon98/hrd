        ...
        <div class="container">
            <div class="gap">
                ...
                <div class="content">
                    ...
                    <form action="./signup_action.jsp" method="post" name="gaib_form" id="gaibForm" >
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sign1" id="sign1" required autofocus></td>
                            </tr>
                            <tr>
                                <th>단위사업장기호<img src="./img/ico-compulsory.png" alt=""></th>
                                <td><input type="text" name="sign2" id="sign2" required autofocus></td>
                            </tr>
                            <tr>
                                <th>아이디<img src="./img/ico-compulsory.png" alt=""></th>
                                <td><input type="text" name="id" id="id" placeholder="영문+숫자 6~10자 이내" required autofocus></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="pw_ok" id="pwOk" placeholder="영문+숫자+특수문자(!@#$) 각 1자 이상 포함하여 9~12자 이내" required autofocus></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="chk_ans" id="chkAns" placeholder="조회 답변은 띄어쓰기 포함 10자 이내" required autofocus></td>
                            </tr>
                            <tr>
                                <th>전화번호<img src="./img/ico-compulsory.png" alt=""></th>
                                <td><input type="text" name="hp" id="hp" placeholder="“-(하이픈)” 없이 입력 (예 : 01012345678)"required autofocus></td>
                            </tr>
                            <tr>
                                <th>업무담당자명<img src="./img/ico-compulsory.png" alt=""></th>
                                <td><input type="text" name="name" id="name" placeholder="사업장의 소속된 직장 가입자 직원 또는 대표자"required autofocus></td>
                            </tr>
                            <tr>
                                <th>이메일<img src="./img/ico-compulsory.png" alt=""></th>
                                <td><input type="text" name="email" id="email" required autofocus ></td>
                            </tr>
                            <tr>
                                <th>소식지 수신여부<img src="./img/ico-compulsory.png" alt=""></th>
                                <td>
                                    <label for="recieveY"><input type="radio" name="recieve" id="recieveY" value="받음" checked="true">받음</label>
                                    <label for="recieveN"><input type="radio" name="recieve" id="recieveN" value="안받음">안받음 (공단의 다양한 소식을 무료로 만나보세요)</label>
                                </td>
                            </tr>
                        </table>
                        <div class="btn-box">

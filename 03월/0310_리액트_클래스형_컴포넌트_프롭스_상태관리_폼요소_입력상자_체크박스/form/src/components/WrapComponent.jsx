...
class WrapComponent extends Component {
    ...
    onChangeCheckEvent1=(e)=>{ //상태관리에 저장
        console.log(e.target.checked); // 선택을 했는지(true) 안했는지(false)
        console.log(e.target.value); // 무엇을 선택했는지 
                ...
                <div className="content">
                    <form name='member_form'id='memberForm' method='post' action="./member_form.php">
                        <ul>
                            ...
                            <li className='fruit'>
                                <label htmlFor="chk1"><input onChange={this.onChangeCheckEvent1} type="checkbox" name='chk1' id='chk1' value='딸기' checked={this.state.chk1}/>딸기</label>
                                <label htmlFor="chk2"><input onChange={this.onChangeCheckEvent2} type="checkbox" name='chk2' id='chk2' value='사과' checked={this.state.chk2}/>사과</label>
                                <label htmlFor="chk3"><input onChange={this.onChangeCheckEvent3} type="checkbox" name='chk3' id='chk3' value='포도' checked={this.state.chk3}/>포도</label>
                                <label htmlFor="chk4"><input onChange={this.onChangeCheckEvent4} type="checkbox" name='chk4' id='chk4' value='수박' checked={this.state.chk4}/>수박</label>
                                <label htmlFor="chk5"><input onChange={this.onChangeCheckEvent5} type="checkbox" name='chk5' id='chk5' value='자몽' checked={this.state.chk5}/>자몽</label>
                            </li>
                            <li className='food'>

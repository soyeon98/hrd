...
export default function HeaderComponent({mapText,isMap,isConfirmModal}) {
                    ...
                    <div className="gap">
                        <div className="content">
                            <div className="row1">
                                <div className="container">
                                    <ul>
                                        <li><Link to="/회원가입페이지" title='회원가입'>회원가입</Link></li>
                                        <li><i>|</i></li>
                                ...
                                <div className="container">
                                    <div className="left">
                                        <h1>
                                            ...
                                            <span><Link to="/메인페이지">마켓컬리</Link></span>
                                            <span><i>|</i></span>
                            ...
                            <nav id='nav' className={`row3 ${state.isFix?' on':''}`}>
                                <div className="container">
                                    ...
                                    <div className="center">
                                        <ul>
                                            <li><Link to='/서브1페이지'>신상품</Link></li>
                                            <li><Link to='/서브2페이지'>베스트</Link></li>
                                            <li><Link to='/서브3페이지'>알뜰상품</Link></li>
                                            <li><Link to='/서브4페이지'>특가혜택</Link></li>
                                        </ul>
                                    </div>
                                    <div className="right">

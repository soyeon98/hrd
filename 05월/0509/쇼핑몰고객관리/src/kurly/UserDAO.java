  ...
  public UserDTO getJoin(String user_id){
    ...
    try{
      ...
      if(rs.next()){
        ...
        userDTO.setUser_birth_year(rs.getString("user_birth_year"));
        userDTO.setUser_birth_month(rs.getString("user_birth_month"));
        userDTO.setUser_birth_date(rs.getString("user_birth_date"));

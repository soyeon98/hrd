    ...
    const onClickUserIdOk=(e)=>{
        ...
        if(regExp2.test(value)===false || regExp3.test(value)===true|| regExp4.test(value)===false || regExp5.test(value)===true ){
            ...
            setState({
                ...state,
                isConModal:true,
                conModalMsg:'6자 이상 16자 이하의 영문 혹은 영문과 숫자를 조합'
            })
        }
        else{
            //아이디 중복검사 실시
                    ...
                    <div id="confirmModal">
                        <div className="wrap">
                            <dov className="container">
                                <div className="title">
                                    <h1>{state.conModalMsg}</h1>
                                </div>
                                <div className="btn-box">
                                    <button onClick={onClickconModalClose}>확인</button>
                                </div>
                            </dov>
                        </div>
                    </div>

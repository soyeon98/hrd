                                    ...
                                    <div>
                                        ...
                                        <div className="sub">
                                            <ul>
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk1' id='category1Chk1'  value={'샐러드 간편식'} />
                                                        샐러드 간편식
                                                   </label>
                                                </li> 
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk2' id='category1Chk1'  value={'과일·견과·쌀'} />
                                                        과일·견과·쌀
                                                   </label>
                                                </li> 
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk3' id='category1Chk1'  value={'국·반찬·메인요리'} />
                                                        국·반찬·메인요리
                                                   </label>
                                                </li> 
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk4' id='category1Chk1'  value={'면·양념·오일'} />
                                                        면·양념·오일
                                                   </label>
                                                </li> 
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk5' id='category1Chk1'  value={'수산·해산·건어물'} />
                                                        수산·해산·건어물
                                                   </label>
                                                </li> 
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk6' id='category1Chk1'  value={'생활용품·리빙·캠핑'} />
                                                        생활용품·리빙·캠핑
                                                   </label>
                                                </li> 
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk7' id='category1Chk1'  value={'헤어·바디·구강'} />
                                                        헤어·바디·구강
                                                   </label>
                                                </li> 
                                               <li>
                                                   <label >
                                                        <input type="checkbox" name='category2_chk8' id='category1Chk1'  value={'베이커리·치즈·델리'} />
                                                        베이커리·치즈·델리
                                                   </label>
                                                </li> 
                                               <li>

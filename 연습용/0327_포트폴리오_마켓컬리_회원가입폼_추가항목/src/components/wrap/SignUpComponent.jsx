...
export default function SignUpComponent({회원가입,timer,timerCounterFn,addressOpenPostcode, 주소1, 주소2}) { //내부 props와 외부 props가 섞이지 않도록 비구조화해서 넣어준다
    ...
    const onChangeUserChooga=(e)=>{
     ...
     const onChangeUserChoogaId=(e)=>{
        let isIdokDisabled =true;
        if(e.target.value.length>1){
            isIdokDisabled =false;
        }
        else{
            isIdokDisabled =true;
        }
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <div className="center-box chooga">
                                                    <label htmlFor=""> 
                                                    <input  
                                                        type="radio" name='user_chooga' id='userChooga1' 
                                                    ...
                                                    <label htmlFor=""> 
                                                    <input  
                                                        type="radio" name='user_chooga' id='userChooga2' 
                                                        onChange={onChangeUserChooga}
                                                        value={'참여 이벤트명'} 
                                                    />
                                                    참여 이벤트명</label>
                                                ...
                                                <div className="chooga-box">
                                                    ...
                                                    }
                                                    {
                                                        ...
                                                        <>
                                                                <input 
                                                                    type="text " name='user_chooga_event' id='userChoogaEvent' 
                                                ...
                                                </div>
                                                {
                                                    state.isChooga1&&(
                                                        <button 
                                                        className={`id-ok-btn ${state.isIdokDisabled?' on':''}`}
                                                        onClick={onClickChoogaIdokBtn}
                                                        disabled={state.isIdokDisabled}
                                                    >아이디 확인</button>
                                                    )
                                                }
